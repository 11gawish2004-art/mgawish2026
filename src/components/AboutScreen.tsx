...
export default function AboutScreen() {
  ...
  const handleDeleteEmployee = async (id: string) => {
    if (window.confirm('هل أنت متأكد من حذف بيانات هذا الموظف؟')) {
      try {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {employees.length === 0 && (
                <div className="col-span-full py-24 text-center">
                  ...
                  <p className="text-stone-400 font-black text-xl italic">لم يتم إضافة موظفين بعد</p>
                </div>
              )}
            </div>
          </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              {documents.length === 0 && (
                <div className="col-span-full py-24 text-center">
                  ...
                  <p className="text-stone-400 font-black text-xl italic">لا توجد مستندات مرفوعة</p>
                </div>
              )}
            </div>
          </motion.div>
