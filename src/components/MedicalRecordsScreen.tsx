...
import { Plus, X, Calendar, User, Hospital, FileText, ClipboardList, Activity, FlaskConical, Database, Image as ImageIcon, CheckCircle2, AlertCircle, Clock, Trash2, Shield, Eye, EyeOff, Loader2, Search, Link as LinkIcon, Stethoscope, Printer, FileDown, FileUp, Download, Info, MapPin, Phone, CreditCard, ChevronLeft, ArrowRight, FileCheck } from 'lucide-react';
...
export default function MedicalRecordsScreen() {
  ...
  const handleAddPatient = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormData({ 
        ...
        isHelped: false, diseaseType: '', attachments: [], notes: '' 
      });
    } catch (error) {
  ...
  const filteredCases = medicalCases.filter(c => {
    ...
    return matchesSearch && matchesStatus && matchesAssistance;
  }).sort((a, b) => {
    let result = 0;
                            ...
                            <div className="flex items-center gap-5">
                               ...
                               <div>
                                  <div className="flex items-center gap-2 mb-1">
                                     <div className="font-black text-emerald-950 text-xl">{patient.name}</div>
                                     {patient.isUnderAge && (
                ...
                <form onSubmit={handleAddPatient} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="md:col-span-2 space-y-4">
                       <FileUploadSlot 
                         label="المستندات المرفقة (روشتات، تحاليل، أشعة، إلخ)"
